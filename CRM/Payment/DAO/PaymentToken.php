 ...
 * @copyright CiviCRM LLC (c) 2004-2014
 *
 * Generated from xml/schema/CRM/Payment/Token.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 */
require_once 'CRM/Core/DAO.php';
require_once 'CRM/Utils/Type.php';
class CRM_Payment_DAO_PaymentToken extends CRM_Core_DAO
{
  /**
  ...
  public $email;
  /**
   * Holds the part of the card number that may be retained or displayed
   *
   * @var string
   */
  public $reference;
